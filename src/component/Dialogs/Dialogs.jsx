...
const Dialogs = (props) => {
    let renderDialogsData = props.dialogsPage.friends.map( (dialog, index) => {
    ...
    return(
        <div className={`default-card ${style.dialogsWrap}`}>
            ...
            <div className={style.chatWrap}>
                ...
                <SendMessage value={props.dialogsPage.chatTextarea} updateMessageTextarea={props.updateMessageTextarea} addNewMessage={props.addNewMessage}/>
            </div>
        </div>
    )
};
