...
const Dialogs = (props) => {
    let renderDialogsData = props.dialogs.friends.map( (dialog, index) => {
    ...
    return(
        <div className={`default-card ${style.dialogsWrap}`}>
            ...
            <div className={style.chatWrap}>
                ...
                <SendMessage updateChatTextarea={props.updateChatTextarea} chatTextarea={props.dialogs.chatTextarea}/>
            </div>
        </div>
    )
}
